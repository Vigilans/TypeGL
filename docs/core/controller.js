...
export class Controller {
    constructor(obj, // 被托管控制的对象
    offset = [0, 0, 0], // 初始物体中心相对于原点的偏移
    scale = 0.0, // 初始等比缩放比例
    rotate = [0, 0, 0], // 三个方向旋转角（先X再Y再Z）
    speed = 1.0 // 变化速度
    ) {
        this.obj = obj;
        this.speed = speed;
        this.T = MV.mat4(); // 平移矩阵的累积
        this.R = MV.mat4(); // 旋转矩阵的累积
        this.S = MV.mat4(); // 缩放矩阵的累积
